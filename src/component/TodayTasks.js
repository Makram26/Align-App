...
export default function TodayTasks({ navigation, name, task, dueDate, assigned, image, priority,status }) {
...

            {
                task === "Today" ?
                    <View style={styles.priorityContiner}>
                        <Text style={styles.textPriority}>Status: </Text>
                        <Exclamation name="exclamation-triangle" size={10} color={priority === false ? COLORS.darkGreen : COLORS.red} />
